...
class Adapter(private val onClick: () -> Unit) :
    Adapter<com.example.taskmanager.ui.onBoarding.adapter.Adapter.OnBoardingHolder>() {
    private val data = arrayListOf(
        OnBoarding("Reflect",
            "Reflect your success with Task Manager!",
            "https://uploads-ssl.webflow.com/6156c92cb3f1a26201745fa2/621b22f337c639bd78db0963_6197773c733ba15f7b3da1da_20943650-min.jpg"),
        OnBoarding("Track Progress",
            "You can easily track your daily progress!",
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnBoardingHolder {
        return OnBoardingHolder(ItemOnboardingBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false))
    }
